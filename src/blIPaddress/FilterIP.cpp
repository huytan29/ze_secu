...
#define FIREWALL_ENGINE_SUBLAYER_NAME L"LancsDLP's WFPFirewall Sublayer"
#define FIREWALL_ENGINE_SUBLAYER_DESC L"Container for filters added by LancsDLP's WFPFirewall"
DEFINE_GUID(
...
bool FirewallEngine::addFilterDataLimit(std::string host, uint32_t ip, uint32_t mask, uint64_t data_limit_bytes) {
    ...
    filter.displayData.name = const_cast<wchar_t*>(L"LancsDLP's WFPFirewall inbound data limit filter");
...
bool FirewallEngine::addFilterTimeLimit(std::string host, uint32_t ip, uint32_t mask, uint64_t time_limit_seconds, bool block, bool persistent) {
    ...
    filter.displayData.name = const_cast<wchar_t*>(L"LancsDLP's WFPFirewall time limit filter");
    filter.displayData.description = const_cast<wchar_t*>(L"LancsDLP's WFPFirewall time limit filter");
